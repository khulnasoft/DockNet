...
- We use GitHub issues to track bugs and enhancement requests. Submit issues for any [feature request and enhancement](https://github.com/khulnasoft/project-defaults/issues/new?assignees=&labels=feature&template=02_feature-request.md&title=), [bugs](https://github.com/khulnasoft/project-defaults/issues/new?assignees=&labels=bug&template=01_bug-report.md&title=), or [documentation](https://github.com/khulnasoft/project-defaults/issues/new?assignees=&labels=documentation&template=03_documentation.md&title=) problems.
...
- Please apply one or more applicable [labels](https://github.com/khulnasoft/project-defaults/labels) to your issue so that all community members are able to cluster the issues better.
...
You are welcome to contribute code in order to fix a bug, to implement a new feature, to propose new documentation, or just to fix a typo. Check out [good first issue](https://github.com/khulnasoft/project-defaults/labels/good%20first%20issue) and [help wanted](https://github.com/khulnasoft/project-defaults/labels/help%20wanted) issues if you want to find open issues to implement.
...
> _Please refer to the [documentation of ml-buildkit](https://github.com/khulnasoft/ml-buildkit#automated-build-pipeline-ci) for instructions on how to execute the build-scripts directly on your machine instead of using the containerized approach documented below. This local execution would not require Docker._
