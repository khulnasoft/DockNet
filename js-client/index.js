...
* <pre>
* var DocknetApi = require('index'); // See note below*.
* var xxxSvc = new DocknetApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new DocknetApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new DocknetApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new DocknetApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
