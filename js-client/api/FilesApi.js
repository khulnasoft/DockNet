...
export default class FilesApi {
    ...
    */
     ...
     * @param {String} projectId A valid project ID.
     * @param {Object} opts Optional parameters
     * @param {Date} opts.dateFrom The start date to delete the files. If not specified, all files will be deleted.
     * @param {Date} opts.dateTo The end date to delete the files. If not specified, all files will be deleted.
