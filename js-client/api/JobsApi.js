...
export default class JobsApi {
    ...
    */
     ...
     * @param {Date} opts.dateFrom The start date to delete the jobs. If not specified, all jobs will be deleted.
     * @param {Date} opts.dateTo The end date to delete the jobs. If not specified, all jobs will be deleted.
